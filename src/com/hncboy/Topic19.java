...
public class Topic19 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Topic19().printMatrix(matrix1));
        System.out.println(new Topic19().printMatrix(new int[][]{{1}}));
        System.out.println(new Topic19().printMatrix(matrix2));
    }
